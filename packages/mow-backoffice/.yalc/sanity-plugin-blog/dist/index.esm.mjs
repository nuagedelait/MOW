...
const baseLang = "fr";
var structure = S => S.list().title("Content").items([S.listItem().title("Build").icon(ControlsIcon).child(S.list().id("build-level").title("Build").items([S.listItem().title("Settings").icon(ControlsIcon).child(S.document().schemaType("siteSettings").documentId("siteSettings")), S.listItem().title("Menus").id("menu-docs").icon(MenuIcon).schemaType("navigation").child(S.documentList().id("navigation").title("Menus").filter('_type == "navigation" && (!defined(_lang) || _lang == $baseLang)').params({
  baseLang
  ...
  baseLang
})), S.listItem().title("Addresses").id("address-docs").icon(PinIcon).schemaType("address").child(S.documentList().id("address").title("Address").filter('_type == "address" && (!defined(_lang) || _lang == $baseLang)').params({
  baseLang
  ...
  baseLang
}))])), S.listItem().title("Documents").icon(DocumentIcon).child(S.list().id("doc-level").title("Documents").items([S.listItem().title("Posts").id("post-docs").icon(DocumentIcon).schemaType("post").child(S.documentList().id("post").title("Posts").filter('_type == "post" && (!defined(_lang) || _lang == $baseLang)').params({
  baseLang
